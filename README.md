...
| [2. Create a merchant](docs/02-create-merchant.md) | Create the account; retain its merchant key; resolve collection context | Merchant ID and name |
...
- The merchant key resolves collection context and authenticates server-side session, collection, identity, and privacy calls. The backend initializes the channel and namespaces; no extra credential handoff is required.
